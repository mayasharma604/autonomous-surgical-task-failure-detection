...
# 2. Data Setup & Split
# -----------------------
# Using the path from your terminal screenshots
...
# Split at the Trial (Folder) level to prevent data leakage
...
# Adjusting classifier for binary classification (Good vs Bad)
...
for epoch in range(epochs):
    ...
    # Calculation of Precision/Recall for Validation
